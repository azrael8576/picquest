            ...
            Text(
                ...
                buildAnnotatedString {
                    withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                        append(stringResource(id = R.string.feature_photo_recent_searches))
                    }
                },
                modifier =
                Modifier.padding(
            ...
            if (recentSearchQueries.isNotEmpty()) {
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription =
                        stringResource(
                            id = R.string.feature_photo_clear_recent_searches_content_desc,
                        ),
    ...
    TextField(
        ...
        leadingIcon = {
            Icon(
                ...
                contentDescription = stringResource(R.string.feature_photo_search),
                tint = MaterialTheme.colorScheme.onSurface,
            )
        },
        trailingIcon = {
            if (searchQuery.isNotEmpty()) {
                IconButton(
                    ...
                    Icon(
                        imageVector = PqIcons.Close,
                        contentDescription = stringResource(R.string.feature_photo_clear_search_text_content_desc),
                        tint = MaterialTheme.colorScheme.onSurface,
                    )
                }
            }
