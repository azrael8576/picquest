...
/**
 * PqAppSnackbar 是一個 Composable function，根據是否為錯誤來顯示不同風格的 Snackbar。
...
/**
 * PqErrorSnackbar 是一個 Composable function，用於顯示錯誤風格的 Snackbar。
 * @param snackbarData Snackbar的數據。
 * @param modifier 修改器，用於修改 Composable function 的屬性。
 * @param actionOnNewLine 是否將操作按鈕換行顯示。
 * @param shape Snackbar 的形狀。
...
/**
 * PqSnackbar 是一個 Composable function，用於顯示普通風格的 Snackbar。
 * @param snackbarData Snackbar的數據。
 * @param modifier 修改器，用於修改 Composable function 的屬性。
 * @param actionOnNewLine 是否將操作按鈕換行顯示。
 * @param shape Snackbar 的形狀。
